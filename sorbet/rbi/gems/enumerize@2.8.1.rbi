...
module Enumerize
  ...
  mixes_in_class_methods ::Enumerize::Integrations::RailsAdmin
...
# source://enumerize//lib/enumerize/integrations/rails_admin.rb#5
module Enumerize::Integrations::RailsAdmin
  # source://enumerize//lib/enumerize/integrations/rails_admin.rb#7
  def enumerize(name, options = T.unsafe(nil)); end
end
