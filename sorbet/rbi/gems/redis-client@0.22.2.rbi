...
module RedisClient::PIDCache
  class << self
    ...
    #
    # source://redis-client//lib/redis_client/pid_cache.rb#28
    def pid; end
  end
end
...
class RedisClient::RubyConnection::BufferedIO
  ...
  #
  # source://redis-client//lib/redis_client/ruby_connection/buffered_io.rb#53
  ...
  # source://redis-client//lib/redis_client/ruby_connection/buffered_io.rb#63
  def gets_chomp; end

  # source://redis-client//lib/redis_client/ruby_connection/buffered_io.rb#159
  def gets_integer; end

  # source://redis-client//lib/redis_client/ruby_connection/buffered_io.rb#74
  ...
  # source://redis-client//lib/redis_client/ruby_connection/buffered_io.rb#81
  def ensure_line; end
...
# source://redis-client//lib/redis_client/ruby_connection/buffered_io.rb#51
