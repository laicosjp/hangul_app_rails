...
class User
  ...
  module GeneratedAssociationMethods
    ...
    def word_record_ids; end

    sig { params(ids: T::Array[T.untyped]).returns(T::Array[T.untyped]) }
    def word_record_ids=(ids); end

    # This method is created by ActiveRecord on the `User` class because it declared `has_many :word_records`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
    sig { returns(::WordRecord::PrivateCollectionProxy) }
    def word_records; end

    sig { params(value: T::Enumerable[::WordRecord]).void }
    def word_records=(value); end
  end
